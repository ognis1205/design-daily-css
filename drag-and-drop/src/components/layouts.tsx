...
>`
  ...
  ${({ paddingX }) => paddingX && `padding-left: ${paddingX}px; padding-right: ${paddingX}px`};
  ${({ paddingY }) => paddingY && `padding-top: ${paddingY}px; padding-bottom: ${paddingY}px`};
  ...
  ${({ marginX }) => marginX && `margin-left: ${marginX}px; margin-right: ${marginX}px`};
  ${({ marginY }) => marginY && `margin-top: ${marginY}px; margin-bottom: ${marginY}px`};
